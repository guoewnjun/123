...
class AppealDetail extends Component {
    ...
    componentDidMount() {
        ...
        if (!this.props.location.query.orderId) {
            ...
            window.location.hash = 'OperatingCenter/DealManage/AppealManage/AppealDetail?orderId=' + orderId
        }
        this.setState({
            loading: true,
        });
    ...
    getOrderDetail() {
        if (this.isFromParkingDetail()) {
            ...
            window.location.hash = `${location.hash.split('?')[0]}/ParkingRecordDetail?id=${this.state.orderId}`;
                ...
                <Spin spinning={loading} tip='加载中...'>
                    <div className='page-header' style={{ paddingBottom: 8 }}>
                        <div style={{ position: 'relative', height: 50 }}>
                            ...
                            {/*历史申诉状态都是已拒绝,因为只有拒绝了的申诉才会进入历史申诉*/}
                            <div
                                style={{
                                    position: 'absolute',
