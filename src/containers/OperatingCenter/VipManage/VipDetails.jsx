...
import {
    Button, Table, Row, Col, Spin, Pagination, Card
} from 'antd';
...
export default class VipDetails extends Component {
    ...
    componentDidMount () {
        ...
        HttpClient.query(`/parking-person-info/business/member/detail?id=${orderId}`, 'GET', null, this.parkingDetail.bind(this));
            this.loadData();
    ...
    loadData(pageNum = 1, pageSize = 10, otherParams) {
        ...
        HttpClient.query('/parking-person-info/business/member/park/list', 'GET', params, this.handleQueryData.bind(this))
    }
                    ...
                    <div className='page-content page-content-transparent'>
                        ...
                        >
                            <Row>
                                ...
                                <Col span={8}>
                                    <label>注册来源：</label>
                                    <span>{laiyuan[detailData.regSource] || '--'}</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={8}>
                        ...
                        >
                            <Row>
                                <Col span={8}>
                                    <label>头像：</label>
                                    <img src={baseInfo.headPortrait||"--"} style={{width:100}}/>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={8}>
