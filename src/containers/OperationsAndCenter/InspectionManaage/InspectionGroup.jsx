...
export default class InspectionGroup extends Component {
    ...
    // 新建稽查组
    addInspectionGroup() {
        location.hash = `${location.hash}/AddInspectionGroup`;
    }

    //编辑排班
    editSchedule(id) {
        location.hash = `${location.hash}/EditSchedule?id=${id}`;
    }

    //编辑稽查组
    editGroup(id) {
        location.hash = `${location.hash}/EditInspectionGroup?id=${id}`;
    }
    ...
    //详情
    detailClick(id) {
        location.hash = `${location.hash}/InspectionGroupDetail?id=${id}`;
    }
